...
class A2SI(nn.Module):
    def __init__(self, cfg):
        ...
        self.img_layer = nn.Linear(512, 256)
        self.running_baseline = 0.0

        
    def update_query_scores_with_reinforce(self, reward, actions):
        self.transformer.update_query_scores_with_reinforce(reward, actions)
    ...
    def forward(self, data_dict):
        ...
        img_feats_c, pcd_feats_c, rl_info = self.transformer(
        ...
        # 添加强化学习信息进 output_dict（为 Trainer 使用）
        output_dict.update(rl_info)
        ...
        output_dict["img_corr_feats"] = img_corr_feats
        output_dict["pcd_corr_feats"] = pcd_corr_feats
