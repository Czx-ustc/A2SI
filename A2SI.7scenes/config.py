...
# data
_C.data = edict()
_C.data.dataset_dir = "/zssd/czx/2D3DMATR/experiments/data/7Scenes"
...
_C.model.transformer.query_hidden_dim = 256
...
_C.model.transformer.query_blocks = ["image", "point cloud", "image", "point cloud", "image", "point cloud"]
_C.model.transformer.use_embedding = True
_C.model.transformer.num_queries = 16
...
_C.loss.feature_consistency_weight = 0.1
_C.loss.start_epoch = 10
_C.loss.feature_consistency_warmup_epochs = 20 


_C.rl = edict()
_C.rl.reward_mode = "schedule"        # 可选: "std", "schedule"
_C.rl.tau = 20.0                 # schedule 模式下的指数增长控制参数
